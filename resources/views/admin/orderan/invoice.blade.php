    ...
    <div class="col-md-12">
        <div class="invoice p-3 mb-3">
            ...
            <div class="row">
              <div class="col-12">
                <h4>
                  <img src="/assets/dist/img/birusaga-biru.png" style="width: 190px; border-radius: 8px">
            ...
            <div class="row invoice-info">
              <div class="col-sm-4 invoice-col">
                ...
                <address>
                  <strong>BIRUSAGA Cakrawala</strong><br>
                  Taman Cibaduyut Indah III Ciguriang<br>
                  Bandung - Jawa Barat<br>
                  08992220067 - 087789836767<br>
                  Email: halo@birusaga.com<br>
                  www.birusaga.com
                </address>
              </div>
              <!-- /.col -->
              ...
              <div class="col-sm-4 invoice-col">
                 ...
                 BS Vendor: <b>{{$data->pesanan_untuk}}</b><br>
              </div>
              <!-- /.col -->
            </div>
            <!-- /.row -->
        ...
        <strong> Rekening Pembayaran :<br>
            Bank         : BRI<br>
            A / N        : JOHNY DARMAWAN<br>
            A / C        : 702101001610502</strong><br>
              <!-- /.col -->
            </div>
            <br>
            <!-- /.row -->
