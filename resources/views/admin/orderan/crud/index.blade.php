              ...
              <div class="row">
                <div class="col-md-12">
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Klien</label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Vendor BIRUsaga</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" placeholder="Silahkan Di isi.." name="pesanan_untuk">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Down Payment/DP</label>
                        <div class="col-sm-10">
                    ...
                    <h4 class="text-center">Detail Order</h4>
                    <div class="kolom_asli">
                      <div class="row mt-4">
                        <div class="col-md-12">
                          <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-1 col-form-label">Order</label>
                            <div class="col-sm-10">
                         ...
                         <hr>
                            ...
                            <div class="kolom_copy" style="display: none">
                              <div class="col-md-12">
                                <h4 class="text-center"><b>Form Tambah Order</b></h4>
                              </div>
                              <div class="col-md-12">
                                <div class="form-group row">
                                  <label for="inputEmail3" class="col-sm-1 col-form-label">Jenis Order</label>
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Masukan Detail Orderan.." name="jenis_orderan[]">
                                    <span class="text-danger">*Seragam Kotak-kotak</span>
                                      </div>
