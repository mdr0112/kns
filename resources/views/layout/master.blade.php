...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link mt-2">
      <span class="brand-image elevation-3" style="opacity: .5">bS</span>
      <center><span class="brand-text font-weight-light">BIRUsaga</span></center>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-header">MANAJEMEN ORDER</li>
          <li class="nav-item">
  ...
  <footer class="main-footer no-print">
    <strong>BIRUsaga &copy; 2024</strong>
  </footer>
